...
/help - Список всіх країн
`

const startText = `
Ти можеш переглянути статистику по <a href="https://covid19.gov.ua">Covid19</a>.
Введи назву країни на латиниці і отримай всі необхідні дані
Переглянути весь список країн можна по команді /help
`
...
const errorText = `
Введи коректну назву країни на латиниці 
Переглянути весь список країн можна по команді /help
`
